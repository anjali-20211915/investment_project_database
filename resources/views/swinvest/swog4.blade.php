                ...
                <div class="container bg-light  ">
                    ...
                    <div class="row">
                        <div class="col-sm-12 swog-form my-form2">
                            <form action="{{url('swog5')}}" method="post" >
                                @csrf
                                <div class="row my-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="my-3" for="uname">Address Line 1</label>
                                            <input type="text"  name="address1" class="form-control" id="uname" placeholder="Street Address or PO Box">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address2" class="form-control" id="uname" placeholder="Apartment, suite, unit, building, floor, etc.">
