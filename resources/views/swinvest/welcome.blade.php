        ...
        <div class="container  center backg">
         ...
         <div class="row">
            <div class="col-sm-12 iamgey">
                <img class="imagew" src="{{url('img/welcome 1.png')}}" alt="">   
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-4 mx-5">
                <a href="{{url('entity-verification')}}" type="button" class="btn last-btn">Get Started<i class="fa-sharp fa-solid fa-arrow-right"></i> </a>
            </div>
            <div class="col-4">
            </div>
         </div>
